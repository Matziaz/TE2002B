  ...
  u10: StateMach
    port map(
      ...
      SubBytesu5Fin   => u5_Finish);
		...
		oAddRoundu0En    <= AddRoundEn;
      oAddRoundu4En    <= AddRoundu4En;
      oAddRoundu7En    <= AddRoundu7En;
      oKeySel          <= KeySel;
		oKeyEn           <= KeyEn;
      oMixColumnsu3En  <= MixColumnsEn;
      oMuxSel          <= MuxSel;
      oShiftRowsu2En   <= ShiftRowsEn;
      oShiftRowsu6En   <= ShiftRowsu6En;
      oSubBytesu1En    <= SubBytesEn;
      oSubBytesu5En    <= SubBytesu5En;
		oSubytesFinish   <= u1_Finish;
		oEderFinish      <= u0_Finish;
		oMarkitosFinish  <= u2_Finish;
